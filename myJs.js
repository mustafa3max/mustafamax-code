...
function showCallMy() {
	...
	document.getElementById("all-call").style = "transition: 3s; transform: translateY(-450px)";
}

function heddinCallMy() {
	document.getElementById("show-call-my").style = "display: none; transition: 3s; transform: translateY(-450px)";
